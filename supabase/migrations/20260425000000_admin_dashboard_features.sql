-- =====================================================
-- TIDYWISE Admin Dashboard: 8 new feature tables
...
CREATE POLICY "Admins insert service_pricing"
  ON public.service_pricing FOR INSERT WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins update service_pricing"
  ON public.service_pricing FOR UPDATE USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete service_pricing"
  ON public.service_pricing FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins insert service_areas"
  ON public.service_areas FOR INSERT WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins update service_areas"
  ON public.service_areas FOR UPDATE USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete service_areas"
  ON public.service_areas FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));

CREATE TRIGGER update_service_areas_updated_at
  BEFORE UPDATE ON public.service_areas
  FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

-- Seed FL service areas matching existing TIDYWISE city pages
...
CREATE POLICY "Admins view quote_requests"
  ON public.quote_requests FOR SELECT USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins update quote_requests"
  ON public.quote_requests FOR UPDATE USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete quote_requests"
  ON public.quote_requests FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Anyone can submit commercial requests"
  ON public.commercial_requests FOR INSERT WITH CHECK (true);
CREATE POLICY "Admins view commercial_requests"
  ON public.commercial_requests FOR SELECT USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins update commercial_requests"
  ON public.commercial_requests FOR UPDATE USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete commercial_requests"
  ON public.commercial_requests FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Anyone can create chatbot conversations"
  ON public.chatbot_conversations FOR INSERT WITH CHECK (true);
CREATE POLICY "Anyone can update chatbot conversations"
  ON public.chatbot_conversations FOR UPDATE USING (true);
CREATE POLICY "Admins view chatbot_conversations"
  ON public.chatbot_conversations FOR SELECT USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete chatbot_conversations"
  ON public.chatbot_conversations FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE INDEX IF NOT EXISTS abandoned_leads_followup_idx
...
CREATE POLICY "Anyone can create abandoned_leads"
  ON public.abandoned_leads FOR INSERT WITH CHECK (true);
CREATE POLICY "Admins view abandoned_leads"
  ON public.abandoned_leads FOR SELECT USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins update abandoned_leads"
  ON public.abandoned_leads FOR UPDATE USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete abandoned_leads"
  ON public.abandoned_leads FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));
...
-- =====================================================
-- 6. WORK_CARDS (Our Work gallery) + storage bucket
-- =====================================================
...
CREATE POLICY "Public read work_cards"
  ON public.work_cards FOR SELECT USING (true);
CREATE POLICY "Admins insert work_cards"
  ON public.work_cards FOR INSERT WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins update work_cards"
  ON public.work_cards FOR UPDATE USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete work_cards"
  ON public.work_cards FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins upload work-photos" ON storage.objects
  FOR INSERT WITH CHECK (
    bucket_id = 'work-photos' AND has_role(auth.uid(), 'admin'::app_role)
  );
CREATE POLICY "Admins delete work-photos" ON storage.objects
  FOR DELETE USING (
    bucket_id = 'work-photos' AND has_role(auth.uid(), 'admin'::app_role)
  );

-- Seed social handles into site_content (table already exists)
...
CREATE POLICY "Admins view all reviews"
  ON public.reviews FOR SELECT USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Anyone can submit review"
  ON public.reviews FOR INSERT WITH CHECK (true);
CREATE POLICY "Admins update reviews"
  ON public.reviews FOR UPDATE USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete reviews"
  ON public.reviews FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Public can view blocked dates"
  ON public.booking_blocked_dates FOR SELECT USING (true);
CREATE POLICY "Admins insert blocked_dates"
  ON public.booking_blocked_dates FOR INSERT WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins update blocked_dates"
  ON public.booking_blocked_dates FOR UPDATE USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins delete blocked_dates"
  ON public.booking_blocked_dates FOR DELETE USING (has_role(auth.uid(), 'admin'::app_role));
