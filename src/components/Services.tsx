...
const services = [
  ...
  },
  {
    ...
    description: "Fast turnovers and spotless guest-ready spaces every time.",
    price: "Custom Quote",
  ...
  },
  {
    ...
    description: "Professional cleaning for offices and commercial workspaces.",
    price: "Custom Quote",
    link: "/office-cleaning",
    features: [
      "Flexible scheduling",
      "OSHA compliant cleaning",
      "Breakroom & restroom sanitation",
